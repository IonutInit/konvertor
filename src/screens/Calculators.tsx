...
const Calculators = () => {
  ...
  const [universalPickerDisplayed, setUniversalPickerDisplayed] =
    useState(false);
    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      ...
      <View>
        {measureType?.map((fromUnit, i) => {
          ...
          useEffect(() => {
            if (isFirstIteration) {
              setUniversalPickerDisplayed(true);
            }
            if (!isFirstIteration) {
              setUniversalPickerDisplayed(false);
            }
          }, [isFirstIteration]);
          ...
          return (
            <View key={i} style={styles.firstComponent}>
              ...
              <FromComponent
                measureType={measureType![i]}
                componentKey={i}
                filter={konvertor === "bmi" ? bmiWeigthFilter : []}
              />
              ...
              <>
                <View style={styles.universalPickerContainer}>
                  {platform === "ios" &&
                    ...
                    isFirstIteration && <UniversalPicker componentKey={i} />}
                </View>
              </>
            </View>
          );
